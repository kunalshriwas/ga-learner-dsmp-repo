...
X =vectorizer.transform(all_text).toarray()
...
# Implementing MultinomialNB model
y_pred = nb.predict(X_test)
nb_accuracy_2 = accuracy_score(y_test,y_pred)
print (str(nb_accuracy_2)+(" is the accuracy of the MultinomialNB model"))

# Implementing LinearSVC model
